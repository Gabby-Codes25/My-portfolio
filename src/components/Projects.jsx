...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${codes})` }}
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>A E-Commerce website built with HTML5 and CSS</p>
              <div className='pt-8 text-center'>
                <a href='https://eccommercesite.netlify.app'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/Gabby-Codes25/E-commerce-website.git'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <div className='pt-8 text-center'>
                ...
                <a href='https://github.com/Gabby-Codes25/Goals.git'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
